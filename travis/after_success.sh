#!/bin/bash
#
# Tomcat-Slf4j-Logback (https://github.com/tomcat-slf4j-logback/tomcat7-slf4j-logback/)
#
...
if [ $TRAVIS_REPO_SLUG == "tomcat-slf4j-logback/tomcat7-slf4j-logback" ] && [ $TRAVIS_PULL_REQUEST == "false" ] && [ $TRAVIS_BRANCH == "master" ] && [[ "$commit_message" != *"[maven-release-plugin]"* ]]; then
